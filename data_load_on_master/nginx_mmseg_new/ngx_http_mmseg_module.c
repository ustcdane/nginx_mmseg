...
mmsegSpace::MMSeg* g_interface = NULL;
//初始化这个模块的函数，在后面有定义
...
static char* ngx_http_mmseg_merge_loc_conf(ngx_conf_t* cf, void* parent, void* child);
...
static ngx_command_t ngx_http_mmseg_commands[] = { 
    {   
        ngx_string("mmseg"), // The command name
...
static ngx_http_module_t ngx_http_mmseg_module_ctx = {
        ...
        NULL,                          /* merge server configuration */
        ngx_http_mmseg_create_loc_conf,/* create location configuration */
        ngx_http_mmseg_merge_loc_conf  /* merge location configuration */
};
...
static void *ngx_http_mmseg_create_loc_conf(ngx_conf_t *cf)
{
        ...
        ngx_str_null(&local_conf->output_words);
...
static char* ngx_http_mmseg_merge_loc_conf(ngx_conf_t* cf, void* parent, void* child) {
	ngx_http_mmseg_loc_conf_t* prev = (ngx_http_mmseg_loc_conf_t*)parent;
	ngx_http_mmseg_loc_conf_t* conf = (ngx_http_mmseg_loc_conf_t*)child;
